#!/usr/bin/env node
/**
 * Demo script: Bad request (tampered body + updated digest)
 */

import { runBadRequestBodyAndDigestDemo } from './demo-client.js';
...
async function main() {
  try {
    ...
    // Run bad request demo (body + digest attack)
    await runBadRequestBodyAndDigestDemo({
      kid: savedKeys.kid,
