#!/usr/bin/env node
/**
 * Demo script: Bad request (replay attack)
 */

import { runBadRequestReplayDemo } from './demo-client.js';
...
async function main() {
  try {
    ...
    // Run bad request demo (replay attack)
    await runBadRequestReplayDemo({
      kid: savedKeys.kid,
